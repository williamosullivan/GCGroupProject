namespace GCGroupProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GCGroupProject.DAL.RecipeContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "GCGroupProject.DAL.RecipeContext";
        }

        protected override void Seed(GCGroupProject.DAL.RecipeContext context)
        {
